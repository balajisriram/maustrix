...
f = figure('Visible','off','MenuBar','none','Name','BCore control','NumberTitle','off','CloseRequestFcn',@cleanup,'Units',units,'Position',[50 50 fWidth fHeight]);
