...
%             preDicrimStim=[];
%             preDicrimStim.stimulus=sm.interTrialLuminance;
%             preDicrimStim.stimType='loop';
%             preDicrimStim.scaleFactor=0;
%             preDicrimStim.startFrame=0;
%             preDicrimStim.autoTrigger=[];
%             preDicrimStim.punishResponses=false;
%             preDicrimStim.ledON = false; 
%             preDicrimStim.soundPlayed = []; 
%             preDicrimStim.framesUntilTimeout = 100;
