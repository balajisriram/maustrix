classdef afcObjects<stimManager
    ...
    methods
        function s = afcObjects(shape,objSize,orientation,contrast,location,maxDuration,normalizationMethod,backgroundLuminance,...
                invertedContrast,drawMode,objectType,mask,maxWidth,maxHeight,scaleFactor,interTrialLuminance,doCombos,doPostDiscrim)
