classdef fullField<stimManager
    ...
    methods
        function s=fullField(frequencies,contrasts,durations,radii,annuli,location,normalizationMethod,mean,thresh,numRepeats, ...
            ...
            elseif isa(location,'RFestimator')
                s.location=location;
            elseif isa(location,'wnEstimator') && strcmp(getType(thresh),'binarySpatial')
                s.location=location;
            else
