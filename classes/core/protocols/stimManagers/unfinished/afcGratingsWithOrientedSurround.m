classdef afcGratingsWithOrientedSurround<stimManager
    ...
    methods
        function s=afcGratingsWithOrientedSurround(pixPerCycs,driftfrequencies,orientations,phases,contrasts,maxDuration,radii,radiusType,location,...
                waveform,normalizationMethod,mean,thresh,maxWidth,maxHeight,scaleFactor,interTrialLuminance, doCombos, doPostDiscrim, LEDParams)
