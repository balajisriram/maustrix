classdef whiteNoiseBubble<stimManager
    ...
    methods
        function s=whiteNoiseBubble(distribution,std,background,method,requestedStimLocation,stixelSize,searchSubspace,numFrames, ...
            ...
            if ~isscalar(searchSubspace) && ~isinf(searchSubspace)
