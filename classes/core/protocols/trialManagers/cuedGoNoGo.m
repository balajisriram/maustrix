classdef cuedGoNoGo<trialManager
    ...
    methods
        function t=cuedGoNoGo(soundManager, rewardManager, eyeController, frameDropCorner, dropFrames, ...
        ...
        function [tm, trialDetails, result, spec, rewardSizeULorMS, requestRewardSizeULorMS, ...
            ...
            [tm.trialManager, possibleTimeout, result, ~, ~, requestRewardSizeULorMS] = ...
                updateTrialState(tm.trialManager, sm, subject, result, spec, ports, lastPorts, ...
                targetPorts, requestPorts, lastRequestPorts, framesInPhase, trialRecords, window, station, ifi, ...
                floatprecision, textures, destRect, requestRewardDone, punishResponses,compiledRecords,updateRM1);
