...
%             end            
        ...
        function [soundsToPlay spec]= getSoundsToPlay(tm, ports, lastPorts, spec, phase, phaseType, stepsInPhase,msRewardSound, msPenaltySound, ...
            ...
            switch trialManagerClass()
                case {'nAFC','biasedNAFC','goNoGo','oddManOut','cuedGoNoGo','changeDetectorTM'}
