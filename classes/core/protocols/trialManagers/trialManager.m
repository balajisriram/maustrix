            ...
            while ~done && ~Quit;
                ...
                if ~paused
                    ...
                    [tm, trialRecords(trialInd).trialDetails, trialRecords(trialInd).result, spec, ...
                        ...
                        tm.updateTrialState(stimManager, trialRecords(trialInd).result, spec, ports, lastPorts, ...
            ...
            try
                ...
                for i=1:length(stimSpecs)
                    ...
                    [phaseData{i}.loop,phaseData{i}.trigger, phaseData{i}.frameIndexed ,phaseData{i}.timeIndexed, ...
                        phaseData{i}.indexedFrames, phaseData{i}.timedFrames, phaseData{i}.strategy, phaseData{i}.toggleStim] = tm.determineStrategy(stim, type, responseOptions, framesUntilTransition);
