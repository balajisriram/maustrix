classdef standardKBStation < station
    ...
    methods
        function s = standardKBStation(id, path, MAC, physLoc)
            s = s@station(id, path, MAC, physLoc);
        end
        
        function [endValveState, valveErrorDetails]=setAndCheckValves(station, requestedValves,~,valveErrorDetails,~,~,~)
