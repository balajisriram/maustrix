classdef standardVisionBehaviorStationWithArduino < standardVisionBehaviorStation
    ...
    methods
        function s = standardVisionBehaviorStationWithArduino(id, path, MAC, physLoc, decPPortAddr, valveSpec, sensorSpec)
