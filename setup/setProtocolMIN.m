...
%adaptiveRewards=adaptiveReinforcement(rewardSizeULorMS,requestRewardSizeULorMS,requestMode,msPenalty,fractionOpenTimeSoundIsOn,fractionPenaltySoundIsOn,scalar,msAirpuff,minRewardScalar,minPenaltyMS,maxPenaltyMS,adaptationMethod);
