...
[or_optim1, or_optim2, ~, ~, ~, or_durLimited, or_durCtr, or_durSweep] = createOrientationSteps_auto(svnRev,svnCheckMode,subID);
...
pMouseTraining_OD = protocol(descriptiveString,{fd_sto,fd,ts_obj1,ts_obj2,...
    or_optim1,or_optim2,or_durLimited,or_durCtr,or_durSweep...
    });
end
