function r = ctxCharPtcl_LED(r,subjIDs,otherParams)
if ~isa(r,'BCore')
    error('need a BCore')
end
...
ffgwn1 = whiteNoise({'gaussian',gray,std,randMethod,seed1},background,method,stimLocation,stixelSize,searchSubspace,numFrames,changeable,maxWidth,maxHeight,scaleFactor,interTrialLuminance,LEDParams);
ffgwn2 = whiteNoise({'gaussian',gray,std,randMethod,seed2},background,method,stimLocation,stixelSize,searchSubspace,numFrames,changeable,maxWidth,maxHeight,scaleFactor,interTrialLuminance,LEDParams);
numFrames = 300;
burnthro = whiteNoise({'gaussian',gray,std,randMethod,seed2},{background,1},method,stimLocation,stixelSize,searchSubspace,numFrames,changeable,maxWidth,maxHeight,scaleFactor,interTrialLuminance,LEDParams);
% spatialsWhiteNoise
searchSubspace=[1];background=gray;
method='texOnPartOfScreen';
changeable=false;
scaleFactor=0;interTrialLuminance=.5;
stimLocation=[0,0,maxWidth,maxHeight];
stimDurationSecs = 30;frameDurationSecs = 0.2;
numFrames = {stimDurationSecs,frameDurationSecs};

minLum = 0; maxLum = 1; nonSparse = 0.5;sparcity = 0.05;

stixelSize = [128 128];
bin6X8 = whiteNoise({'binary',minLum,maxLum,nonSparse},background,method,stimLocation,stixelSize,searchSubspace,numFrames,changeable,maxWidth,maxHeight,scaleFactor,interTrialLuminance,LEDParams);
sparseBin6X8Bright = whiteNoise({'binary',minLum,maxLum,sparcity},background,method,stimLocation,stixelSize,searchSubspace,numFrames,changeable,maxWidth,maxHeight,scaleFactor,interTrialLuminance,LEDParams);
sparseBin6X8Dark = whiteNoise({'binary',minLum,maxLum,1-sparcity},background,method,stimLocation,stixelSize,searchSubspace,numFrames,changeable,maxWidth,maxHeight,scaleFactor,interTrialLuminance,LEDParams);
stixelSize = [64 64];
bin12X16 = whiteNoise({'binary',minLum,maxLum,nonSparse},background,method,stimLocation,stixelSize,searchSubspace,numFrames,changeable,maxWidth,maxHeight,scaleFactor,interTrialLuminance,LEDParams);
sparseBin12X16Bright = whiteNoise({'binary',minLum,maxLum,sparcity},background,method,stimLocation,stixelSize,searchSubspace,numFrames,changeable,maxWidth,maxHeight,scaleFactor,interTrialLuminance,LEDParams);
sparseBin12X16Dark = whiteNoise({'binary',minLum,maxLum,1-sparcity},background,method,stimLocation,stixelSize,searchSubspace,numFrames,changeable,maxWidth,maxHeight,scaleFactor,interTrialLuminance,LEDParams);
stixelSize = [32 32];
bin24X32 = whiteNoise({'binary',minLum,maxLum,nonSparse},background,method,stimLocation,stixelSize,searchSubspace,numFrames,changeable,maxWidth,maxHeight,scaleFactor,interTrialLuminance,LEDParams);

stimDurationSecs = 5;frameDurationSecs = 0.2;
stixelSize = [64 64];
numFrames = {stimDurationSecs,frameDurationSecs};
minLum = [0 0.1 0.2 0.3 0.4]; maxLum = [1 0.9 0.8 0.7 0.6];
burnthro = whiteNoise({'binary',minLum,maxLum,nonSparse},{background,1},method,stimLocation,stixelSize,searchSubspace,numFrames,changeable,maxWidth,maxHeight,scaleFactor,interTrialLuminance,LEDParams);
