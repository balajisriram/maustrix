function r = setProtocolDEMO_RR(r,subjIDs)
...
ims=fullfile('PRimageset'); %'\\Reinagel-lab.ad.ucsd.edu\rlab\Rodent-Data\PriyaV\other stimuli sets\paintbrushMORPHflashlightEDF';
if ispc
    imageDir=fullfile('\\ghosh-nas.ucsd.edu\ghosh\imFiles',ims);
elseif ismac
    targ='/Volumes/rlab';
